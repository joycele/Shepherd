...
#
#   Malmo MISSION SPEC SETUP STUFF
#

# Draw corral for sheeps to go in
# Note: this is where our shepherd must go to finish the mission
def getShelter():
    cave_side_length = 10
    cave = '''<DrawCuboid x1="30" y1="205" z1="10" x2="50" y2="217" z2="-10" type="air"/>'''
    floor = '''<DrawCuboid x1="30" y1="205" z1="10" x2="50" y2="205" z2="-10" type="sea_lantern"/>'''
    pen =  '''<DrawLine x1="30" y1="206" z1="10" x2="30" y2="206" z2="-10" type="fence"/>''' 
    jumpoff = '''<DrawLine x1="32" y1="206" z1="0" x2="34" y2="206" z2="0" type="pumpkin"/>
                <DrawBlock x="35" y="206" z="0" type="acacia_stairs"/>'''
    return cave + floor + pen + jumpoff
...
def getSpawnerBlocks():
    ...
    for item in range(NUM_GOALS):
        ...
        xml += '''<DrawBlock x="''' + x + '''" y="207" z="''' + z + '''" type="mob_spawner" variant="''' + MOB_TYPE + '''"/>'''
    return xml
...
# Draw the wheat randomly in the arena
def getItemXML():
...
# Generate dimension string for drawing cuboids in XML
# Note: this is confusing and icky; I don't like it
...
# Well this generates the XML for setting up the world/mission for our shepherd
...
#
# TKinter SETUP CODE AND FUNCTIONS
#
if sys.version_info[0] == 2:
...
# Draw the sheep and wheat on TKinter
...
#
#   STATE OBSERVATION STUFF
#
def getSafeSheepCount(entities):
    safeSheep = 0
    for ent in entities:
        if ent["name"] == MOB_TYPE and canvasX(ent["x"]) > 400:
            safeSheep += 1
    return safeSheep
...
# Look at 30 directions agent can possibly turn to and pick the best one
...
#
#   MAIN EXECUTION MEAT OF THE MACHINE STUFF
#

# Boring Background Malmo stuff
validate = True
...
for iRepeat in range(num_reps):
    ...
    for retry in range(max_retries):
        try:
            ...
            agent_host.startMission( my_mission, my_client_pool, my_mission_record, 0, "Shepherd test" )
            break
    ...
    while world_state.is_mission_running:
        ...
        if world_state.number_of_observations_since_last_state > 0:
            ...
            if "entities" in ob:
                ...
                sheepies = getSafeSheepCount(entities)
                if sheepies > 0:
                    print("# of sheepies saved = ", sheepies)
